    ...
    <footer className="footer">
      <nav className="footer__nav-wrapper">
        <ul className="footer__page-links">
          ...
          <li>
            <a className="footer__page-link" href="https://groshmed.com" target={'_blank'} rel="noreferrer">
              My Homepage
            </a>
          </li>
        </ul>
        <ul className="footer__social-links">
          <li>
            <a className="footer__social-link" href="https://github.com/konstkhal" target={'_blank'} rel="noreferrer">
              <img className="footer__social-link-image" src={github} alt="Github icon"></img>
            </a>
          </li>
          <li>
            <a className="footer__social-link" href="https://www.linkedin.com/in/konstkhal" target={'_blank'} rel="noreferrer">
              <img className="footer__social-link-image" src={linkedIn} alt="LinkedIn icon"></img>
            </a>
          </li>
          <li>
            <a className="footer__social-link" href="https://twitter.com/konstak" target={'_blank'} rel="noreferrer">
              <img className="footer__social-link-image" src={twitter} alt="Twitter icon"></img>
            </a>
          </li>
          <li>
            <a className="footer__social-link" href="https://facebook.com/konstkhal" target={'_blank'} rel="noreferrer">
